...
/**
 * Event annotation, determines an upper bound for the event emission rate in events per time unit.
 *
...
public @interface MaxRate {
    /**
     * Settings name {@code "maxRate"} for configuring an event emission rate in events per time unit.
     */
    public static final String NAME = "maxRate";
