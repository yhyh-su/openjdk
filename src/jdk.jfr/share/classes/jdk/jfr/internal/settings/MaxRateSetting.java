...
import jdk.jfr.internal.MaxRate;
...
@MetadataDefinition
@Label("MaxRate")
@Description("Upper bounds the event emission rate")
@Name(Type.SETTINGS_PREFIX + "MaxRate")
public final class MaxRateSetting extends JDKSettingControl {
    public static final String DEFAULT_VALUE = MaxRate.DEFAULT;
    private final PlatformEventType eventType;
    private String value = DEFAULT_VALUE;

    public MaxRateSetting(PlatformEventType eventType) {
    ...
    public void setValue(String value) {
        if ("off".equals(value)) {
            eventType.setMaxRate(Double.MAX_VALUE);
            this.value = value;
            return;
        }
